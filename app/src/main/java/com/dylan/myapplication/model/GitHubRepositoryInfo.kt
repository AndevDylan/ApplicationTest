package com.dylan.myapplication.model
...
class GitHubRepositoryInfo {
    ...
    var privateX: Boolean? = null

    @SerializedName("owner")
    var owner: RepoOwnerInfo? = null
    ...
    class LicenseInfo {
        ...
        override fun toString(): String {
            return "LicenseInfo(key=$key, name=$name, spdxId=$spdxId, url=$url, nodeId=$nodeId)"
        }
